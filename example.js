(() => {
  ...
  var require_document3 = __commonJS((exports) => {
    ...
    var _document1 = _interopRequireDefault2(require_document2());
    var _ruleNames = require_ruleNames();
    function _assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  ...
  var require_class2 = __commonJS((exports) => {
    ...
    var _reaction2 = require_lib();
    function isClass(argument) {
      return isSubclassOf(argument, _reaction2.React.Component);
    }
    function isSubclassOf(argument, Class) {
      var subclass = false;
      if (argument.name === Class.name) {
              ...
              _createClass(_class12, [
                {
                  ...
                  value: function render(update) {
                    ...
                    return _get(_getPrototypeOf(_class12.prototype), "render", this).call(this, update);
                  }
                }
              ]);
              return _class12;
        ...
        get: function() {
          return function() {
            ...
            var Function2 = function(props, context, element) {
              ...
              props = appendClassNameToProps(className, props);
              return (_React = _reaction2.React).createElement.apply(_React, [
                tagName,
                props
  ...
  var require_sizeable = __commonJS((exports) => {
    ...
    var Component = _reaction2.React.Component;
    var SizeableDiv = function(Component2) {
      _inherits(SizeableDiv2, Component2);
  ...
  var require_textarea = __commonJS((exports) => {
    ...
    var Component = _reaction2.React.Component;
    var Textarea = function(Component2) {
      _inherits(Textarea2, Component2);
      function Textarea2() {
      ...
      _createClass(Textarea2, [
        {
          key: "componentDidMount",
          value: function componentDidMount() {
            var _props = this.props, onKeyUp2 = _props.onKeyUp;
            if (onKeyUp2) {
              var keyUpHandler = onKeyUp2;
    ...
    var _default = _index2.default(Textarea)(_templateObject());
    exports.default = _default;
  ...
  var require_cursor = __commonJS((exports) => {
    ...
    exports.default = void 0;
    var previousCursor;
    var bodyDOMElement2 = document.querySelector("body");
    ...
    function setCursor(cursor) {
      bodyDOMElement2.style.cursor = cursor;
    }
    function getCurrentCursor() {
      var currentCursor = bodyDOMElement2.style.cursor;
      return currentCursor || "auto";
    }
  });

  // lib/utilities/sibling.js
  var require_sibling = __commonJS((exports) => {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
  ...
  var require_vertical = __commonJS((exports) => {
    ...
    var Component = _reaction2.React.Component;
    var VerticalSplitterDiv = function(Component2) {
      _inherits(VerticalSplitterDiv2, Component2);
    ...
    var View = function(Component2) {
      ...
      _createClass(View2, [
        ...
        },
        {
          ...
          value: function render(update) {
            return [
              _reaction2.React.createElement(_heading.default, null, "Reaction with Style example"),
              _reaction2.React.createElement(_columns.default, null, _reaction2.React.createElement(_sizeable.default, null, _reaction2.React.createElement(_rows.default, null, _reaction2.React.createElement(_subHeading.default, null, "Lexical entries"), _reaction2.React.createElement(_lexicalEntries.default, {
                onKeyUp: this.keyUpHandler
              }), _reaction2.React.createElement(_subHeading.default, null, "BNF"), _reaction2.React.createElement(_bnf.default, {
                onKeyUp: this.keyUpHandler
              }))), _reaction2.React.createElement(_vertical.default, null), _reaction2.React.createElement(_column.default, null, _reaction2.React.createElement(_rows.default, null, _reaction2.React.createElement(_subHeading.default, null, "Content"), _reaction2.React.createElement(_content.default, {
                onKeyUp: this.keyUpHandler
              }), _reaction2.React.createElement(_subHeading.default, null, "Parse tree"), _reaction2.React.createElement(_parseTree.default, null))))
            ];
          }
        }
      ]);
  ...
  _reaction.ReactDOM.render(_reaction.React.createElement(_view.default, null), bodyDOMElement);
})();
